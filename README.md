...
The program learns the values of m (slope) and b (intercept) that best fit the data by minimizing prediction error through gradient descent. The data set included in this project are random numbers generated by me. The temperature and tree-health values are illustrative and are not intended to represent validated environmental research.
